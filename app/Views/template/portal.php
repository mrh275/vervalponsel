...
<body>
    ...
    <div class="container-fluid px-0 sticky-top portal-header">
        <header class="d-flex flex-wrap bg-light justify-content-center py-3 mb-4">
            <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img src="<?= base_url('assets/img') ?>/logo.png" class="ms-5 me-3" alt="logo-sman1rawamerta" width="40" height="40">
                <span class="fs-4">SMA Negeri 1 Rawamerta</span>
            </a>
        </header>
    </div>
            ...
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div class="col-md-4 d-flex align-items-center">
                    <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                        <img src="<?= base_url('assets/img') ?>/logo.png" class="ms-5 me-3" alt="logo-sman1rawamerta" width="30" height="30">
                    </a>
