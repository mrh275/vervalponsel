<?= $this->extend('template/login-admin') ?>
    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-3">
        <div class="row align-items-center g-lg-5 py-3">
            <div class="col-lg-7 text-center text-lg-start">
                <h1 class="display-4 fw-bold lh-1 mb-3">Login Admin Verval Ponsel SMANESTA</h1>
            ...
            <div class="col-md-10 mx-auto col-lg-5">
                ...
                <form class="p-4 p-md-5 border rounded-3 bg-light form-login" method="post" action="<?= base_url('login/admin') ?>" id="login-form">
